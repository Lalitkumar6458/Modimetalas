...
export const FlangeOptionsData = [
  {
    id: 1,
    
    grade: "ANSI Norm Flanges",
    link: "/ANSI_Norm_Flanges",
  ...
  },
  {
    ...
    grade: "EN Norm Flanges",
    link: "/EN_Norm_Flanges",
  },
  {
    id: 4,

    grade: "BS Norm Flanges",
    link: "/BS_Norm_Flanges",
  },
  {
    id: 5,
    
    grade: "JIS Norm Flanges",
    link: "/JIS_Norm_Flangess",
...
export const ENNormFlangesData = [
  {
    ...
    Specification: [
      ...
      "Forged stainless steel flange dimensions conform to ASME B16.5",
    ...
    chemical: {
      grade:
        "Stainless Steel Pr EN 1092-1 Flanges| Carbon Steel Pr EN 1092-1 Flanges| Nickel Alloys Pr EN 1092-1 Flanges",
      "Size :": "DN15 - DN2000",
      "Standard: ": "EN 1092",
      "Type:":
        "Weld Neck Flanges(Raised Face), EN Norm flanges, Loose Flanges, Plate Flanges, Blind Flanges Process: Forged, Stamped",
      "Pressure grade:": "PN6, PN10, PN16, PN25, PN40",
    },
    products_Flanges: {
      PlateFlanges: [
        " EN 1092-1 Type 01 PN6",

        "EN 1092-1 Type 01 PN10",

        "EN 1092-1 Type 01 PN16",

        "EN 1092-1 Type 01 PN25",

        "EN 1092-1 Type 01 PN40",

        "EN 1092-1 Type 02 PN16",
      ],
      Welding_Neck_Flanges: [
        "EN 1092-1 Type 11 PN6",

        "EN 1092-1 Type 11 PN10",

        " EN 1092-1 Type 11 PN16",

        "EN 1092-1 Type 11 PN25",

        "EN 1092-1 Type 11 PN40",
      ],
      ThreadedFlanges: ["  EN 1092-1 Type 13 PN6", "EN 1092-1 Type 13 PN16"],
      Blind_Flanges: [
        "EN 1092-1 Type 05 PN6",

        "EN 1092-1 Type 05 PN10",

        "EN 1092-1 Type 05 PN16",
      ],
    },
  },
];
...
export const BSNormFlangesData = [
  {
    ...
    products_Flanges: {
      "BS 4504 Flanges": [
        " Plate Flanges Code 101",

        "Weld Neck Flanges Code 111",
        " Blind Flanges Code 105",

        "Slip On Flanges Code 112",

        " Thereated Flanges Code 113",
      ],
    },
  },
];
...
export const JISNormFlangesData = [
  {
    ...
    products_Flanges: {
      "JIS B2220 Flanges": [
        " D & M 5kg SOP/SOH/BLIND1",
        "D & M 10kg SOP/SOH/BLIND",
        " D & M 16kg SOP/SOH/BLIND",
        "D & M 20kg SOP/SOH/BLIND",
      ],
    },
  },
];
...
export const UNINormFlangesData = [
  {
    ...
    products_Flanges: [
      "UNI 2276 PN6 Flanges",
      "UNI 2277 PN10 Flanges",
      "UNI 2278 PN16 Flange",
      "UNI 6089 PN10Flanges",
      "UNI 6089 PN16 FlangeS",
    ]
...
"Class 1500",
"Class 2500",
"Class150 – Weld Neck , Series A",
"Class 150 – Weld Neck , Series B",
"Class 300 – Weld Neck& Blind, Series A",
"Class 150 – Weld Neck & Blind, Series B",
"Class 600 – Series A & B",
"Class 900 – Series A & B"
      ],
      "Slip On Flanges":[
        "Class 300",
        "Class 400",
...
export const  Flange_Grade_alloys=[{
...
{
  heading:"Carbon Steel ASTM A 234",
